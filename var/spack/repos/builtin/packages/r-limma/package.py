...
class RLimma(RPackage):
    ...
    url      = "https://bioconductor.org/packages/release/bioc/src/contrib/limma_3.42.0.tar.gz"

    version('3.42.0', sha256='966b5e5371108c408f32ed878e797a018dd6daa605ca7d682e59d985cdb6de31')
    ...
    depends_on('r@3.6.0:', when='@3.42.0')
