...
class RGenomeinfodb(RPackage):
    ...
    url      = "https://bioconductor.org/packages/3.10/bioc/src/contrib/GenomeInfoDb_1.22.0.tar.gz"

    version('1.22.0', sha256='a0a701ea3aee552b71ead95167573fe61c27f6206e80f4c2701945578596f41f')
    ...
    depends_on('r@3.1.0:', when='@1.22.0', type=('build', 'run'))
