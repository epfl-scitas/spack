...
class RSummarizedexperiment(RPackage):
    ...
    url      = "https://bioconductor.org/packages/3.10/bioc/src/contrib/SummarizedExperiment_1.16.0.tar.gz"

    version('1.16.0', sha256='1529b1e87fc62175b76caedc89d64e6a086f724f1b87b36586fa359f08779212')
    ...
    depends_on('r-genomicranges@1.33.6:', when='@1.16.0', type=('build', 'run'))
    ...
    depends_on('r-s4vectors@0.23.20:', when='@1.16.0:', type=('build', 'run'))
